      ...
      <section style={{display:"flex", margin:"0 10%", gap:"20px"}}>
        <div className="container" style={{ display: "block", border:" 2px solid rgb(208, 178, 20)", borderRadius:"5px"}}>
          ...
          <p className="para font">
            ...
            page is contact page followed by About page and Investor Relation
            page.
          </p>
          <br />
        ...
        <div className="container" style={{ display: "block", border:" 2px solid rgb(208, 178, 20)", borderRadius:"5px" }}>
          ...
          <p className="para font">
            ...
            your grocery shopping lists anytime, anywhere. Say goodbye to
        ...
        <div className="container" style={{ display: "block", border:" 2px solid rgb(208, 178, 20)", borderRadius:"5px" }}>
          ...
          <p className="para font">
            I developed a task manager application that allows users to
            efficiently manage their tasks by providing functionality to add new
        ...
        <div className="container" style={{ display: "block", border:" 2px solid rgb(208, 178, 20)", borderRadius:"5px" }}>
          ...
          <p className="para font">
            I developed a dynamic web application inspired by Swiggy. The
            application features functionalities such as viewing menus, adding
